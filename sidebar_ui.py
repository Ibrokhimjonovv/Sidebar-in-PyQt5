...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icon/icons/question-mark-4-32.ico"))
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 354, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.logo_label_2.setPixmap(QtGui.QPixmap(":/icon/icons/question-mark-4-32.ico"))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/icons/dashboard-5-32.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon6.addPixmap(QtGui.QPixmap(":/icon/icons/dashboard-5-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon6.addPixmap(QtGui.QPixmap(":/icon/icons/dashboard-5-48.ico"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icons/menu-4-32.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icons/search-13-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icons/user-48.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
